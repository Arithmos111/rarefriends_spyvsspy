...
Written while building and deploying a live multiplayer entry on FriendSDK v0.1.0
(commit `da4828f8ec49d8ac5c24556908bd4cd653f8db67`). Each of these cost real time, and
none of them can be worked around from inside a game.

## A wrong-network wallet is indistinguishable from owning no Friends
